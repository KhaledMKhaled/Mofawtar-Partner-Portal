...
export const customers = pgTable(
  "customers",
  {
    ...
    primaryPhoneWhatsapp: boolean("primary_phone_whatsapp").notNull().default(false),
    altPhone: varchar("alt_phone", { length: 50 }),
    altPhoneWhatsapp: boolean("alt_phone_whatsapp").notNull().default(false),
    email: varchar("email", { length: 200 }),
    address: text("address"),
    taxOffice: varchar("tax_office", { length: 200 }),
    businessActivity: varchar("business_activity", { length: 200 }),
    nameOnTaxCard: varchar("name_on_tax_card", { length: 250 }),
    commercialRegistry: varchar("commercial_registry", { length: 50 }),
